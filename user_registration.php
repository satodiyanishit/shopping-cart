...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name)) {
        ...
        $stmt = $conn->prepare("SELECT * FROM cart_users WHERE name = ?");
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO cart_users (name, email, phone, password) VALUES (?, ?, ?, ?)");
...
<head>
    ...
    <link rel="stylesheet" href="./admin/admin_css/adminregistration.css">
</head>
        ...
        <div class="registration_form">
            <div class="item_form">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="login">Already registered? <a href="user_login.php">Login</a></div>
                </form>
